const playerBios = {
  Ulrike: {
    name: "Ulrike Albeseder",
    role: "Oboe & Blockflöte",
    pdf: "assets/pdf/ulrike-albeseder-bio.pdf",
    text: `
      <p>Die österreichische Oboistin und Blockflötistin Ulrike Albeseder studierte an der Universität für Musik und darstellende Kunst Wien bei Prof. Klaus Lienbacher und Prof. Hans Maria Kneihs sowie an der Musikhochschule München bei Prof. Günther Passin, wo sie jeweils mit Auszeichnung abschloss. Für ihre herausragenden Leistungen wurde sie mit dem Würdigungspreis der Universität Wien geehrt und beim renommierten Wettbewerb Gradus ad Parnassum mit dem Sonderpreis der Wiener Philharmoniker ausgezeichnet. 
       ...
       Ihr künstlerisches Profil zeichnet sich durch Virtuosität, klangliche Feinheit und eine außergewöhnliche stilistische Offenheit aus. Damit gelingt es ihr, sowohl in klassischen Konzertsälen als auch in experimentellen und genreübergreifenden Kontexten ein breites Publikum zu begeistern.</p>
    `,
  },
  Uwe: {
    name: "Uwe Hanewald",
    role: "Akkordeon, Arrangements & Vocals",
    pdf: "assets/pdf/uwe-hanewald-bio.pdf",
    text: `
      <p>Uwe Hanewald ist Akkordeonist, Sänger und vielseitiger Musiker, der mit großer Offenheit zwischen verschiedenen Stilen und Klangwelten agiert. Sein musikalischer Weg begann mit dem klassischen Akkordeon, wo er die technischen Grundlagen und die Ausdrucksmöglichkeiten des Instruments erlernte. Schon früh entwickelte er dabei ein Gespür für die Balance zwischen Virtuosität und Klangpoesie. 
...
Sein Schaffen lebt vom Dialog und der Freude am gemeinsamen Musizieren – neugierig, ausdrucksstark und stets auf der Suche nach neuen Klangwelten.</p>
    `,
  },
  Maye: {
    name: "Wolfgang Mayé",
    role: "Kontrabaß",
    pdf: "assets/pdf/wolfgang-maye-bio.pdf",
    text: `
      <p>Wolfgang Mayé ist Kontrabassist mit einer besonderen Leidenschaft für die tiefen Töne und die Vielfalt musikalischer Ausdrucksformen. Sein Weg begann mit einer achtjährigen klassischen Celloausbildung, ehe er den Kontrabass für sich entdeckte – ein Instrument, das ihm durch seine Klangtiefe, Vielseitigkeit und Nähe zur Improvisation neue Horizonte eröffnete. 
Früh sammelte er prägende Erfahrungen: Als Mitglied des Landesjugendjazzorchesters Schleswig-Holstein entwickelte er seine Begeisterung für Jazz und Ensemble-Spiel. Mit der Weltmusik-Gruppe FISFÜZ gewann er 1998 den Weltmusikpreis „Querbeet“ (ausgeschrieben vom heutigen SWR). Workshops mit renommierten Musikern wie Peter Herbert, Peer Matthiesen, Jamala Deen Tacuma, Marc Abrams und John Saß, ebenso wie Unterricht bei Johannes Schädlich und Michael Schneider, erweiterten seine musikalische Bandbreite und prägten seine Handschrift als Bassist. 
Seit Anfang 2019 ist er festes Mitglied von Mélange à Deux & Amis, wo er die Musik mit seinem warmen Ton, rhythmischer Klarheit und feiner Gestaltungskraft entscheidend prägt. Wolfgang Mayé bewegt sich mühelos zwischen Jazz, Klassik, Weltmusik und improvisierter Musik. Sein Spiel vereint Erdung und Beweglichkeit: mal als tragendes Fundament, mal mit virtuoser Linienführung oder farbigen Akzenten. 
Bei aller Professionalität bleibt er dabei stets neugierig, offen und nahbar – Eigenschaften, die ihn nicht nur zu einem gefragten Musiker, sondern auch zu einem geschätzten Partner auf und neben der Bühne machen.</p>
    `,
  },
  Disch: {
    name: "Wolfgang Disch",
    role: "Schlagzeug/Percussion",
    pdf: "assets/pdf/wolfgang-disch-bio.pdf",
    text: `
      <p>Wolfgang Disch ist Schlagzeuger und Perkussionist mit einem weiten musikalischen Horizont von Jazz über Pop bis hin zu genreübergreifenden Projekten. Er studierte Jazzschlagzeug an der Staatlichen Hochschule für Musik Mannheim bei Prof. Keith Copeland und Prof. Michael Küttner und ist seit seiner Studienzeit als Live- und Studiomusiker aktiv. 
...
Sein Spiel ist geprägt von technischer Souveränität, rhythmischer Präzision und einem sensiblen Gespür für musikalische Atmosphären. Dabei bewegt er sich mühelos zwischen akzentuierter Begleitung und eigenständiger Gestaltung – immer im Dienst des musikalischen Dialogs. </p>
    `,
  },
};
